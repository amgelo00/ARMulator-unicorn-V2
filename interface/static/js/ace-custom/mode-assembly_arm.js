define("ace/mode/assembly_arm_highlight_rules", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    ...
    var AssemblyARMHighlightRules = function () {
        this.$rules = {
            start: [
                ...
                { token: "asmcomment.assembly", regex: ";.*$" },
                {
                ...
                { token: "constant.character.assembly", regex: "#-?[0-9]+" },
                { token: "label.assembly", regex: "^[ \t]*[a-zA-Z0-9_]*" },
            ],
        };
    ...
    AssemblyARMHighlightRules.metaData = {
        fileTypes: ["s"],
        name: "Assembly arm",
...
define("ace/mode/assembly_arm", [
    "require",
    "exports",
    "module",
    "ace/lib/oop",
    "ace/mode/text",
    "ace/mode/assembly_arm_highlight_rules",
    ...
    var AssemblyARMHighlightRules =
        require("./assembly_arm_highlight_rules").AssemblyARMHighlightRules;
